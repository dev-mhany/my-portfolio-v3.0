...
//Custom components
import SocialNetworkRowStack from 'app/components/SocialNetworkRowStack'
  ...
  useEffect(() => {
    const fetchVersion = async () => {
      const response = await fetch(
        'https://api.github.com/repos/Glaysonvisgueira/glaysonvisgueira_next-js/contents/package.json'
      )
      ...
      <div id='grid'>
        ...
        <ScrollAnimation animateIn='fadeIn' animateOnce delay={400}>
          <SectionFooterMenu>
            ...
            <FooterTextExternalLink
              href='https://github.com/Glaysonvisgueira/glaysonvisgueira_next-js'
              target='_blank'
            >
              Github
            </FooterTextExternalLink>
        ...
        <ScrollAnimation animateIn='fadeIn' animateOnce delay={800}>
          <SectionFooterMenu>
            ...
            <FooterTextExternalLink
              href='https://analytics.umami.is/share/6fxpADR03bK8xSHp/web%20portfolio'
              target='_blank'
            >
