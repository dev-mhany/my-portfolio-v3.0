...
//Components
import { FluidContainer } from 'app/styles/ui'
...
const CardService = styled.div`
  ...
  .box {
    ...
    background: linear-gradient(
      133deg,
      ${props => props.theme.colors.brandingDarker} 0%,
      ${props => props.theme.colors.branding} 100%
    );
...
export default function ServicesOffer() {
  ...
  return (
    <FluidContainer id='section-services'>
      <SectionServices>
        <TitleSection
          title={language.servicesOffer.title}
          subtitle={language.servicesOffer.subtitle}
          hasMarginBottom
        />
