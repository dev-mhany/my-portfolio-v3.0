...
export default function Testimonials() {
  ...
  return (
    <Section id='testimonials'>
      <TitleSection
        title={language.testimonialPage.title}
        subtitle={language.testimonialPage.subtitle}
        hasMarginBottom
      />
      ...
      <Marquee
        ...
        direction='left'
        speed={60}
        gradientColor={theme.colors.backgroundPageRgb}
      >
        {[1, 2, 3, 4, 5, 6].map((testimonial, index) => (
          <Testimonial key={index}>
            ...
            <p>
              ...
              blanditiis saepe nisi ipsum quidem, sapiente iusto deleniti vero nesciunt
              quasi aut, assumenda fugit! Eaque deserunt veritatis officiis voluptate
              repellat.
            </p>
